                  ...
                  <Button className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 p-4 h-auto rounded-xl border-2 border-green-600">
                    <div className="flex items-center justify-center space-x-3">
                      ...
                      <div className="text-left">
                        <div className="font-semibold text-lg">Create New Story</div>
                        <div className="text-sm opacity-90">Share your impact with the community</div>
                      </div>
                    </div>
                  </Button>
                </Link>

                {/* Secondary Actions - Navigation Grid */}
                <div className="grid grid-cols-2 gap-3">
                  <Link to="/stories?tab=my">
                    <Button variant="outline" className="w-full p-4 h-auto flex-col hover:bg-primary-50 border-primary-200 hover:border-primary-300 shadow-sm hover:shadow-medium transition-all duration-300 rounded-xl">
                      <Edit className="w-6 h-6 mb-2 text-primary-600" />
                      <span className="text-primary-700 font-medium">My Stories</span>
                      <span className="text-xs text-primary-500 mt-1">Manage & Edit</span>
                    </Button>
                  </Link>
                  <Link to="/stories">
                    <Button variant="outline" className="w-full p-4 h-auto flex-col hover:bg-primary-50 border-primary-200 hover:border-primary-300 shadow-sm hover:shadow-medium transition-all duration-300 rounded-xl">
                      <Eye className="w-6 h-6 mb-2 text-primary-600" />
                      <span className="text-primary-700 font-medium">Browse All</span>
                      <span className="text-xs text-primary-500 mt-1">Explore Stories</span>
                    </Button>
                  </Link>
                </div>
              </div>
